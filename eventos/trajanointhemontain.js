  ...
  form.addEventListener('submit', async event => {
    ...
    try {
      ...
      const payload = {
        ...
        whatsapp: formData.get('whatsapp') || formData.get('telefone'),
        cidade: formData.get('cidade'),
        experiencia: formData.get('experiencia'),
        experiencia_escalada: formData.get('experiencia_escalada'),
        participantes: formData.get('participantes'),
        observacoes: formData.get('observacoes') || formData.get('mensagem')
      };
      ...
      window.location.href =
        '../inscricao/obrigado.html?type=event&id=trajano-in-the-mountain';
...
function renderEvent(event, data) {
  ...
  ctaButtons.forEach(button => {
    button.classList.toggle('btn-disabled', soldOut || postponed || cancelled || comingSoon);
  ...
  setElementVisible(ctaBox, published);
  ...
  setElementVisible(formSection, published && !comingSoon);
