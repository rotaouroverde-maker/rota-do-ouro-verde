...
const stageData = {
  ...
  dia2: {
    ...
    subtitle: '16 km | Continuidade do percurso',
    content: `
      <div class="support-block"><h4>Perfil da etapa</h4><p>Etapa de conexão entre núcleos históricos e áreas rurais, ideal para observar o ritmo da região.</p></div>
      <div class="support-block"><h4>Atenção</h4><ul><li>Planejar alimentação do dia</li><li>Confirmar pontos de apoio previamente</li></ul></div>
    `
  },
  dia3: {
...
function openStageModal(key, button) {
